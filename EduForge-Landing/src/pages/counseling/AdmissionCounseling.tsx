...
import { Building2, FileText, CheckCircle, Users, ArrowRight, ArrowLeft } from 'lucide-react';
...
const services = [
  {
    ...
    description: 'Shortlist universities that match your academic profile, budget, and career goals.',
    color: 'text-amber-500 bg-amber-100'
  },
  {
    icon: FileText,
    title: 'Application Strategy',
    description: 'Craft compelling statements of purpose (SOPs) and standout application essays.',
    color: 'text-purple-500 bg-purple-100'
  },
  {
    icon: Users,
    title: 'Interview Prep',
    description: 'Mock interviews with admission experts to build your confidence.',
    color: 'text-sky-500 bg-sky-100'
  },
  {
    icon: CheckCircle,
    title: 'Profile Building',
    description: 'Enhance your extracurricular profile to stand out to competitive admission committees.',
    color: 'text-emerald-500 bg-emerald-100'
  }
];

const AdmissionCounseling: React.FC = () => {
  return (
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        >
          <motion.div variants={fadeInUp} className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white border border-slate-200 shadow-sm mb-6">
            ...
            <span className="text-amber-600 text-sm font-bold tracking-widest uppercase">Admission Counseling</span>
          </motion.div>

          <motion.h1 variants={fadeInUp} className="text-5xl md:text-7xl font-extrabold text-slate-900 mb-8 tracking-tight">
            Secure Your <br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-500 to-orange-500">Dream College</span>
          </motion.h1>
          
          <motion.p variants={fadeInUp} className="text-lg md:text-xl text-slate-500 max-w-2xl mx-auto font-medium mb-10">
            Navigate the competitive admissions landscape with confidence. Our experts guide you from university selection to acceptance letters.
          </motion.p>
